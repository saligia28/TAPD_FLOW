...
from services.sync.frontend import story_matches_owner  # type: ignore


def test_owner_match_via_frontend_field_with_separator_char():
    story = {"前端": "江林"}
    assert story_matches_owner(story, ["江林"]) is True
...
def test_owner_match_negative_when_not_owner_or_frontend():
    ...
    assert story_matches_owner(story, ["江林"]) is False
